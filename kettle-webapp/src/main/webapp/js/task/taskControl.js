...
function showTaskControlPanel(){
  //  var secondGuidePanel=Ext.getCmp("secondGuidePanel");
    ...
    var cm=new Ext.grid.ColumnModel([
        ...
        {header:"carteObjectId",dataIndex:"carteObjectId",align:"center"},
    ...
    var controlRecord=Ext.data.Record.create([
        ...
        {name:"carteObjectId",type:"string",mapping:"carteObjectId"},
    ...
    store.load({params:{start:0,limit:15}});    //创建panel
