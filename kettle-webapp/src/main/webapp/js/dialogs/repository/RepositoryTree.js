RepositoryTree = Ext.extend(KettleTree, {
	...
	initComponent: function() {
		var loader = new Ext.tree.TreeLoader({
			...
			baseParams: {loadElement: this.loadElement,type:this.type}
		});
...
RepositoryExplorerWindow = Ext.extend(Ext.Window, {
	...
	initComponent: function() {
		...
		var tree = new RepositoryTree({region: 'center', loadElement: this.loadElement,type:'JOB'});
...
RepositoryExplorerWindowTrans = Ext.extend(Ext.Window, {
	width: 400,
	height: 500,
	layout: 'border',
	modal: true,
	...
	initComponent: function() {
		...
		var type ='trans';
		var tree = new RepositoryTree({region: 'center', loadElement: this.loadElement,type:'trans'});
		...
		RepositoryExplorerWindowTrans.superclass.initComponent.call(this);
