...
//			System.out.println(dm.get);
		...
		//	dbMeta.setName("192.168.1.222_Mysql_databefore0710");
		...
		//	meta.setName("192.168.1.222_Mysql_databefore0710");
			meta.setId("KettleDatabaseRepository");
			meta.setConnection(dbMeta);
			meta.setDescription("192.168.1.201_kettle");
		//	meta.setDescription("192.168.1.222_Mysql_databefore0710");
